...
public class AprioriAlgorithm {
    ...
    private double minSupport = 0.01D;
    private double minConfidence = 0.20D;
    private int maxItemSetSize = 10;
    private boolean isQuickRun = true;
    private int maxJoinedSetsSizeWhenQuickRun = 2000;
    ...
    public AnalysisResult analyze(List<Transaction> transactions) throws AprioriTimeoutException {
        ...
        System.out.println("YYY " + oneCItemSets.size() + " :: " + oneElementItemSets.size());
        ...
        while (currentLItemSets.size() != 0) {
            ...
            System.out.println("Calculating currentLItemSets " +
    ...
    private Set<FrequentItemSet> findItemSetsMinSupportSatisfied(
        ...
        for (Map.Entry<ItemSet, Integer> each : localFrequencies.entrySet()) {
            ...
            //this a temp fix for spase itemset
            Double support = (localCount.doubleValue()/new Double(transactions.size()))*200;
            //Double support = (localCount.doubleValue()/new Double(transactions.size()));
